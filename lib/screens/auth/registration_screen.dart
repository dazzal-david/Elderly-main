            ...
            children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Height (cm) *',
                        border: OutlineInputBorder(),
                        helperText: '50-300 cm',  // Added helper text
                      ),
                      keyboardType: TextInputType.number,
                      validator: (value) {
                        if (value?.isEmpty ?? true) return 'Required';
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Weight (kg) *',
                        border: OutlineInputBorder(),
                        helperText: '1-500 kg',  // Added helper text
                      ),
                      keyboardType: TextInputType.number,
                      validator: (value) {
                        if (value?.isEmpty ?? true) return 'Required';
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  border: OutlineInputBorder(),
                  helperText: 'Enter 10 digits only',  // Added helper text
                ),
                keyboardType: TextInputType.phone,
                maxLength: 10,  // Added maxLength
                inputFormatters: [
                  FilteringTextInputFormatter.digitsOnly,  // Add this import: import 'package:flutter/services.dart';
